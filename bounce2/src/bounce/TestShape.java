...
public class TestShape {
	...
	public void testShapeMoveWithBounceOffRight() {
		...
		shape.move(135, 10000);
		shape.paint(_painter);
		assertEquals("(rectangle 100,20,25,35)(rectangle 110,35,25,35)" + "(rectangle 98,50,25,35)",
				_painter.toString());
	}
	...
	public void testShapeMoveWithBounceOffLeft() {
		...
		shape.move(10000, 10000);
		shape.paint(_painter);
		assertEquals("(rectangle 10,20,25,35)(rectangle 0,35,25,35)" + "(rectangle 12,50,25,35)", _painter.toString());
	}
	...
	public void testShapeMoveWithBounceOffBottomAndRight() {
		...
		shape.move(125, 135);
		shape.paint(_painter);
		assertEquals("(rectangle 10,90,25,35)(rectangle 0,100,25,35)" + "(rectangle 12,85,25,35)", _painter.toString());
	}
