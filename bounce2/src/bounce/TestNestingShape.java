...
public class TestNestingShape {
	...
	public void setUpNestedStructure() throws Exception {
		_topLevelNest = new NestingShape(0, 0, 2, 2, 100, 100, "word");
		_midLevelNest = new NestingShape(0, 0, 2, 2, 50, 50, "word");
		_bottomLevelNest = new NestingShape(5, 5, 2, 2, 10, 10, "word");
		_simpleShape = new RectangleShape(1, 1, 1, 1, 5, 5, "word");
	...
	public void testAddWithOutOfBoundsArgument() {
		Shape rectangle = new RectangleShape(80, 80, 2, 2, 50, 50, "word");
