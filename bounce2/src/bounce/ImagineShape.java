...
public class ImagineShape extends Shape {
	...
	public ImagineShape(int x, int y, int deltaX, int deltaY, int width, int height) {

		super(x, y, deltaX, deltaY, width, height);
		_listShapes.add(new DynamicRectangleShape(x, y, deltaX, deltaY, width, height, java.awt.Color.magenta));
		createColors();
	}
